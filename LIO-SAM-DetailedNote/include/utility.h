...
public:
    ...
    */
    sensor_msgs::Imu imuConverter(const sensor_msgs::Imu& imu_in)
    {
        ...
        // 为什么是右乘，可以动手画一下看看
        // Eigen::Quaterniond q_final = q_from * extQRPY.inverse();此处代码应该是这样，下述写错了 
        Eigen::Quaterniond q_final = q_from * extQRPY;        //q_from * extQRPY = q_w_bk * q_bk_lk = q_final  (extQRPY(extrinsicRPY) 在代码中只用于计算q_final)
